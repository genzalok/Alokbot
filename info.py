...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001664556478').split()]
...
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/filmyrip_official')
